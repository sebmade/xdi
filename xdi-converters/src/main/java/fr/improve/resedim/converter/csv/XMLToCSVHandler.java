...
public class XMLToCSVHandler extends DefaultHandler {
    ...
    public XMLToCSVHandler(Properties in_properties, Writer in_writer) {
        ...
        _initValues(l_fields);
        _writer = in_writer;
    }

    private void _initValues(int in_length) {
        _values = new String[in_length];
